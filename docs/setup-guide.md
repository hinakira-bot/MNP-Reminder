...
- **学習完了を押すと** → 本人だけに確認メッセージが表示されます（他の人には見えません）
- **実践完了を押すと** → 本人に確認メッセージ ＋ 実践報告チャンネルに「🎉 ○○さんが実践しました！」と共有されます
- **ロールが設定されている場合** → 実践完了を押すと自動でロールが付きます
...
メンバーの状態に応じて、異なるリマインドが送られます。

| メンバーの状態 | リマインド内容 |
|--------------|--------------|
| 学習済み → まだ実践していない | 🎯「学んだことを活かして実践に挑戦しましょう！」 |
| 実践経験あり → 一定期間実践なし | 🔥「継続は力なり！次の実践に挑戦しましょう！」 |

※ 学習のみのリマインドはありません。リマインドは**実践に関するもののみ**です。
